...
#tbaa_type_desc5 = #llvm.tbaa_type_desc<id = "", members = {<#tbaa_type_desc1, 0>, <#tbaa_type_desc2, 8>, <#tbaa_type_desc2, 12>}>
...
#tbaa_tag1 = #llvm.tbaa_tag<base_type = #tbaa_type_desc5, access_type = #tbaa_type_desc2, offset = 8>
#tbaa_tag2 = #llvm.tbaa_tag<base_type = #tbaa_type_desc5, access_type = #tbaa_type_desc2, offset = 12>
#tbaa_tag3 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 16>
#tbaa_tag4 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 48>
#tbaa_tag5 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 32>
#tbaa_tag6 = #llvm.tbaa_tag<base_type = #tbaa_type_desc5, access_type = #tbaa_type_desc1, offset = 0>
#tbaa_tag7 = #llvm.tbaa_tag<base_type = #tbaa_type_desc3, access_type = #tbaa_type_desc2, offset = 0>
#tbaa_tag8 = #llvm.tbaa_tag<base_type = #tbaa_type_desc3, access_type = #tbaa_type_desc2, offset = 4>
#tbaa_tag9 = #llvm.tbaa_tag<base_type = #tbaa_type_desc4, access_type = #tbaa_type_desc2, offset = 0>
#tbaa_tag10 = #llvm.tbaa_tag<base_type = #tbaa_type_desc4, access_type = #tbaa_type_desc2, offset = 4>
#tbaa_tag11 = #llvm.tbaa_tag<base_type = #tbaa_type_desc4, access_type = #tbaa_type_desc2, offset = 8>
#tbaa_tag12 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 0>
#tbaa_tag13 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 4>
#tbaa_tag14 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 8>
#tbaa_tag15 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 12>
#tbaa_tag16 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 20>
#tbaa_tag17 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 24>
#tbaa_tag18 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 28>
#tbaa_tag19 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 36>
#tbaa_tag20 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 40>
#tbaa_tag21 = #llvm.tbaa_tag<base_type = #tbaa_type_desc6, access_type = #tbaa_type_desc2, offset = 44>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f16, dense<16> : vector<2xi64>>, #dlti.dl_entry<f64, dense<64> : vector<2xi64>>, #dlti.dl_entry<f128, dense<128> : vector<2xi64>>, #dlti.dl_entry<i8, dense<8> : vector<2xi64>>, #dlti.dl_entry<i16, dense<16> : vector<2xi64>>, #dlti.dl_entry<i32, dense<32> : vector<2xi64>>, #dlti.dl_entry<i1, dense<8> : vector<2xi64>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi64>>, #dlti.dl_entry<i64, dense<64> : vector<2xi64>>, #dlti.dl_entry<"dlti.endianness", "little">>} {
  ...
  llvm.func internal unnamed_addr spir_funccc @_ZL17TTL_create_layoutjj(%arg0: !llvm.ptr {llvm.align = 4 : i64, llvm.noalias, llvm.nocapture, llvm.sret = !llvm.struct<"struct.TTL_layout_t", (i32, i32)>, llvm.writeonly}, %arg1: i32 {llvm.noundef}, %arg2: i32 {llvm.noundef}) attributes {dso_local, frame_pointer = #llvm.framePointerKind<all>, memory = #llvm.memory_effects<other = none, argMem = write, inaccessibleMem = none>, passthrough = ["mustprogress", "nofree", "noinline", "norecurse", "nosync", "nounwind", "willreturn", ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"]]} {
    %0 = llvm.mlir.constant(0 : i64) : i64
    %1 = llvm.mlir.constant(1 : i32) : i32
    llvm.store %arg1, %arg0 {alignment = 4 : i64, tbaa = [#tbaa_tag7]} : i32, !llvm.ptr
    %2 = llvm.getelementptr inbounds %arg0[%0, 1] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<"struct.TTL_layout_t", (i32, i32)>
    llvm.store %arg2, %2 {alignment = 4 : i64, tbaa = [#tbaa_tag8]} : i32, !llvm.ptr
    llvm.return
  }
  llvm.func internal unnamed_addr spir_funccc @_ZL17TTL_create_offsetiii(%arg0: !llvm.ptr {llvm.align = 4 : i64, llvm.noalias, llvm.nocapture, llvm.sret = !llvm.struct<"struct.TTL_offset_t", (i32, i32, i32)>, llvm.writeonly}, %arg1: i32 {llvm.noundef}, %arg2: i32 {llvm.noundef}) attributes {dso_local, frame_pointer = #llvm.framePointerKind<all>, memory = #llvm.memory_effects<other = none, argMem = write, inaccessibleMem = none>, passthrough = ["mustprogress", "nofree", "noinline", "norecurse", "nosync", "nounwind", "willreturn", ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"]]} {
    %0 = llvm.mlir.constant(0 : i64) : i64
    %1 = llvm.mlir.constant(1 : i32) : i32
    %2 = llvm.mlir.constant(2 : i32) : i32
    %3 = llvm.mlir.constant(0 : i32) : i32
    llvm.store %arg1, %arg0 {alignment = 4 : i64, tbaa = [#tbaa_tag9]} : i32, !llvm.ptr
    %4 = llvm.getelementptr inbounds %arg0[%0, 1] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<"struct.TTL_offset_t", (i32, i32, i32)>
    llvm.store %arg2, %4 {alignment = 4 : i64, tbaa = [#tbaa_tag10]} : i32, !llvm.ptr
    %5 = llvm.getelementptr inbounds %arg0[%0, 2] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<"struct.TTL_offset_t", (i32, i32, i32)>
    llvm.store %3, %5 {alignment = 4 : i64, tbaa = [#tbaa_tag11]} : i32, !llvm.ptr
    llvm.return
  }
  llvm.func internal unnamed_addr spir_funccc @TTL_linearize(%arg0: !llvm.ptr {llvm.align = 4 : i64, llvm.byval = !llvm.struct<"struct.TTL_offset_t", (i32, i32, i32)>, llvm.nocapture, llvm.noundef, llvm.readonly}, %arg1: !llvm.ptr {llvm.align = 4 : i64, llvm.byval = !llvm.struct<"struct.TTL_layout_t", (i32, i32)>, llvm.nocapture, llvm.noundef, llvm.readonly}) -> i32 attributes {dso_local, frame_pointer = #llvm.framePointerKind<all>, memory = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = none>, passthrough = ["mustprogress", "nofree", "noinline", "norecurse", "nosync", "nounwind", "willreturn", ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"]]} {
    %0 = llvm.mlir.constant(0 : i64) : i64
    %1 = llvm.mlir.constant(2 : i32) : i32
    %2 = llvm.mlir.constant(1 : i32) : i32
    %3 = llvm.getelementptr inbounds %arg0[%0, 2] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<"struct.TTL_offset_t", (i32, i32, i32)>
    %4 = llvm.load %3 {alignment = 4 : i64, tbaa = [#tbaa_tag11]} : !llvm.ptr -> i32
    %5 = llvm.getelementptr inbounds %arg1[%0, 1] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<"struct.TTL_layout_t", (i32, i32)>
    %6 = llvm.load %5 {alignment = 4 : i64, tbaa = [#tbaa_tag8]} : !llvm.ptr -> i32
    %7 = llvm.mul %6, %4  : i32
    %8 = llvm.getelementptr inbounds %arg0[%0, 1] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<"struct.TTL_offset_t", (i32, i32, i32)>
    %9 = llvm.load %8 {alignment = 4 : i64, tbaa = [#tbaa_tag10]} : !llvm.ptr -> i32
    %10 = llvm.load %arg1 {alignment = 4 : i64, tbaa = [#tbaa_tag7]} : !llvm.ptr -> i32
    %11 = llvm.mul %10, %9  : i32
    %12 = llvm.add %11, %7  : i32
    %13 = llvm.load %arg0 {alignment = 4 : i64, tbaa = [#tbaa_tag9]} : !llvm.ptr -> i32
