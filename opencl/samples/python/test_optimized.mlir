module {
  emitc.func private @sigmoid_TTL_optimized(%arg0: !emitc.array<64x128xf32> {llvm.noalias}, %arg1: !emitc.array<64x128xf32> {llvm.noalias}) attributes {specifiers = ["static"]} {
